...
저는 **연세대학교 미래캠퍼스 의료시스템공학**을 전공했으며,  
연계전공으로 **신촌캠퍼스 인지과학**을 공부했습니다.

학부 시절에는 주로 **Python 기반 의료 AI**를 학습했고,  
C/C++은 독학으로 익히며 개발 역량을 넓혀왔습니다.

또한 **회로 설계와 PCB 설계 경험**을 바탕으로  
...
**AI를 활용해 북마크를 자동 분류하고 관리하는 지능형 시스템**
